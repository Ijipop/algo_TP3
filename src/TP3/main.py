...
def main():
    ...
    # notification_manager.subscribe(Notification("Email"))
    # notification_manager.subscribe(Notification("SMS"))
    # notification_manager.subscribe(Notification("Push"))
    ...
    print("\n--- Recherche ---")
    results = library.book_manager.search_books_by_title("Clean")
